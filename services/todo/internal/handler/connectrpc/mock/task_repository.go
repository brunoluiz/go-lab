...
// Source: services/todo/internal/repo/repository.go
//
// Generated by this command:
//
//	mockgen -source=services/todo/internal/repo/repository.go -destination=services/todo/internal/handler/connectrpc/mock/task_repository.go -package=mock TaskRepository
//
...
import (
	...
	model "github.com/brunoluiz/go-lab/services/todo/internal/model"
...
func (m *MockTaskRepository) ListTasks(ctx context.Context, listID string) ([]model.Task, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTasks", ctx, listID)
	ret0, _ := ret[0].([]model.Task)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTaskRepositoryMockRecorder) ListTasks(ctx, listID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTasks", reflect.TypeOf((*MockTaskRepository)(nil).ListTasks), ctx, listID)
}
